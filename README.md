...
🤓 Analista de Dados no Sesc SP na área de Compliance. <br>
📚 Formado em Sistemas de Informação e Pós Graduado em Data Science 

Amante de novas tecnologias que colaboraram para otimizar, automatizar e amparar decisões estratégicas. 

Conhecimento básico em algumas tecnologias como: <br>
 🎯 Python | SQL | Power Platform - Power BI | Power Apps | Power Automate | Figma
